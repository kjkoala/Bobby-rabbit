...
export const fadeOutAnim = Animation.fromSpriteSheet(fadeImage, range(0, 9), 100, AnimationStrategy.End)
export const fadeInAnim = Animation.fromSpriteSheet(fadeImage, range(0, 9), 100, AnimationStrategy.End)
export const leftAnim = Animation.fromSpriteSheet(leftImage, range(0, 8), 120, AnimationStrategy.Loop)
export const rightAnim = Animation.fromSpriteSheet(rightImage, range(0, 8), 120, AnimationStrategy.Loop)
export const upAnim = Animation.fromSpriteSheet(upImage, range(0, 8), 120, AnimationStrategy.Loop)
export const downAnim = Animation.fromSpriteSheet(downImage, range(0, 8), 120, AnimationStrategy.Loop)