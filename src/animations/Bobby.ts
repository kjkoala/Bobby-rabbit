...
export const deathAnim = Animation.fromSpriteSheet(deathImage, range(0, 8), 120, AnimationStrategy.Freeze)
export const fadeAnim = Animation.fromSpriteSheet(fadeImage, range(0, 9), 100, AnimationStrategy.End)
